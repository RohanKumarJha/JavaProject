...
public class ServiceRequest {
	...
	public ServiceRequest(Integer serviceId, String brand, List<String> issues, Long contactNumber, String customerName,
			LocalDateTime timeOfRequest, Float serviceFee, Status status, Long iMEINumber) {
		super();
